...
void main() {
  ...
  group('SmartLogScreen Widget Tests', () {
    ...
    testWidgets('Renders SmartLogScreen, accepts input, triggers sims, and logs', (WidgetTester tester) async {
    ...
    testWidgets('Header back button navigates home and clears AI state', (WidgetTester tester) async {
      final state = AppState();
