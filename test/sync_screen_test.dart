...
void main() {
  ...
  group('SyncScreen Widget Tests', () {
    ...
    testWidgets('Renders SyncScreen, toggles connection, syncs, and edits permissions', (WidgetTester tester) async {
      ...
      expect(switches, findsAtLeastNWidgets(6)); // 1 for HC, 5 for permissions
